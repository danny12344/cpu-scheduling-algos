...
public abstract class Process implements Comparable<Process> {
  ...
  protected int createdTime; /*** point in time the process was created */ //submission time
  protected int startedTime; /*** point in time the process was running for the first time */
  protected int terminatedTime; /*** point in time the process terminated */ //completion time
  ...
  public int getWaitingTime() {
    ...
    int waitingTime = turnAroundTime - (cpuTime + blockedTime); //if blocked not in readyQueue i.e. not ready to go
